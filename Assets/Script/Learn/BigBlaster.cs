...
namespace Learn
{
    public class BigBlaster : LearnBase
    {
        [Header("Stats")]
        ...
        private void Start()
        {
            level = LearnLevelEnum.Epic;
            displayName = "Big Blaster";
            description = "Catch the big blaster on target ";
            damageDescription = "Damage: d20 + intelligence";
        }
    }
}
